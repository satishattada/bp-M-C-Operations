...
import AddTeamModal from "../_components/addTeamMemberModal/addTeamModal";
import teamService from "../_services/teamService";
import { teamDataAtom, TeamReq } from "../_atoms/teamAtoms";
...
function TeamViewComponent() {
  ...
  return (
    <>
      ...
      />
      <div className="headContain d-flex justify-content-between mt-5 mb-4">
      ...
      <Pagination>
        ...
        <Pagination.Next
          onClick={() =>
            handlePageChange(Math.min(currentPage + 1, totalItems))
          }
        />
      </Pagination>
    </>
